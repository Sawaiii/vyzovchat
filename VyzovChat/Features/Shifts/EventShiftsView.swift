        ...
        GlassCard {
            VStack(alignment: .leading, spacing: Spacing.s) {
                ...
                if let open = myOpenShift {
                    ...
                    // закрытой, а отработанные часы обнулялись. Админ через
                    // отметку за сотрудника упирается в то же самое.
                    Text("Смена закрыта, отработанное время засчитано. Открыть её заново нельзя.")
